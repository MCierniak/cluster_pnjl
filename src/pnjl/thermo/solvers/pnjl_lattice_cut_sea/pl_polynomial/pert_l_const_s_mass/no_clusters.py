...
def Polyakov_loop_inner(phi, T, mu):
    ...
    pnjl_l = 2.0*pnjl.thermo.gcp_pnjl.lattice_cut_sea.gcp_q_l_real(T, mu, phi[0], phi[1])
    pnjl_s = pnjl.thermo.gcp_pnjl.lattice_cut_sea.gcp_q_s_real(T, mu, phi[0], phi[1])
    return math.fsum([
        sigma, gluon,
