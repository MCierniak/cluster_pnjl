...
def pickle_lattice_data():
    ...
    (low_1204_6710v2_mu100_x, low_1204_6710v2_mu100_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu100_low.dat", 0, 1
    )
    (high_1204_6710v2_mu100_x, high_1204_6710v2_mu100_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu100_high.dat", 0, 1
    )
    (low_1204_6710v2_mu200_x, low_1204_6710v2_mu200_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu200_low.dat", 0, 1
    )
    (high_1204_6710v2_mu200_x, high_1204_6710v2_mu200_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu200_high.dat", 0, 1
    )
    (low_1204_6710v2_mu300_x, low_1204_6710v2_mu300_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu300_low.dat", 0, 1
    )
    (high_1204_6710v2_mu300_x, high_1204_6710v2_mu300_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu300_high.dat", 0, 1
    )
    (low_1204_6710v2_mu400_x, low_1204_6710v2_mu400_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu400_low.dat", 0, 1
    )
    (high_1204_6710v2_mu400_x, high_1204_6710v2_mu400_y) = utils.data_load(
        "D:/EoS/epja/lattice_data_raw/1204_6710v2_table4_pressure_mu400_high.dat", 0, 1
    )
    (T_lQCD_R12_0p4_high, lQCD_R12_0p4_high) = utils.data_load("D:/EoS/epja/lattice_data_raw/2012_12894_R12_0p4_high.dat", 0, 1)
    (T_lQCD_R12_0p4_low, lQCD_R12_0p4_low) = utils.data_load("D:/EoS/epja/lattice_data_raw/2012_12894_R12_0p4_low.dat", 0, 1)
    ...
    for x_el, y_el in zip(low_1005_3508_x[::-1], low_1005_3508_y[::-1]):
        borsanyi_1005_3508.append(numpy.array([x_el, y_el]))
    borsanyi_1005_3508 = numpy.array(borsanyi_1005_3508)
    lQCD_0p8 = [numpy.array([x_el, y_el]) for x_el, y_el in zip(T_lQCD_R12_0p8_high, lQCD_R12_0p8_high)]
    ...
    with open("D:/EoS/epja/lattice_data_pickled/2012_12894_R12_0p4.pickle", "wb") as file:
        pickle.dump(lQCD_0p4, file)
    with open("D:/EoS/epja/lattice_data_pickled/2012_12894_R12_0p8.pickle", "wb") as file:
        pickle.dump(lQCD_0p8, file)
