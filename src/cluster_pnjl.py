...
def epja_figure1_annals_phys():
    ...
    s_v = numpy.linspace(0.004, 3.0, num=10000)
...
def epja_experimental_pert():
    ...
    def qgp_bdensity_all(T: float, muB: float, phi_re_0=1e-5, phi_im_0=2e-5, calc_phi=True):
        ...
        #Gluon bdensity
        partial.append(gluon.bdensity(*pars_muB)/(T**3))
        #Sea bdensity
        lq_temp = pnjl.thermo.gcp_sea_lattice.bdensity(T, muB/3.0, 'l')/(T**3)
        sq_temp = pnjl.thermo.gcp_sea_lattice.bdensity(T, muB/3.0, 's')/(T**3)
        partial.append(lq_temp)
    ...
    def qgp_sdensity_all(T: float, muB: float, phi_re_0=1e-5, phi_im_0=2e-5, calc_phi=True):
        ...
        #Gluon sdensity
        partial.append(gluon.sdensity(*pars_muB)/(T**3))
        #Sea sdensity
        lq_temp = pnjl.thermo.gcp_sea_lattice.sdensity(T, muB/3.0, 'l')/(T**3)
        sq_temp = pnjl.thermo.gcp_sea_lattice.sdensity(T, muB/3.0, 's')/(T**3)
        partial.append(lq_temp)
    ...
    ax1.plot(T_1, qgp_old_sdensity_v_1, '--', c = 'blue')
    ax1.plot(T_1, qgp_sdensity_v_1, '-', c = 'blue')
    ax1.plot(T_1, t_pnjl_sdensity_old_1, '-.', c = 'darkblue')
    ax1.plot(T_1, t_pnjl_sdensity_1, '-', c = 'darkblue')
    ax1.plot(T_1, t_pert_sdensity_old_1, '-.', c = 'magenta')
    ax1.plot(T_1, t_pert_sdensity_1, '-', c = 'magenta')
    ax1.plot(T_1, t_gluon_sdensity_old_1, '-.', c = 'red')
    ax1.plot(T_1, t_gluon_sdensity_1, '-', c = 'red')
    ax1.plot(T_1, t_quark_sdensity_old_1, ':', c = 'purple')
    ...
    ax2.plot(T_2, qgp_old_sdensity_v_2, '--', c = 'blue')
    ax2.plot(T_2, qgp_sdensity_v_2, '-', c = 'blue')
    ax2.plot(T_2, t_pnjl_sdensity_old_2, '-.', c = 'darkblue')
    ax2.plot(T_2, t_pnjl_sdensity_2, '-', c = 'darkblue')
    ax2.plot(T_2, t_pert_sdensity_old_2, '-.', c = 'magenta')
    ax2.plot(T_2, t_pert_sdensity_2, '-', c = 'magenta')
    ax2.plot(T_2, t_gluon_sdensity_old_2, '-.', c = 'red')
    ax2.plot(T_2, t_gluon_sdensity_2, '-', c = 'red')
    ax2.plot(T_2, t_quark_sdensity_old_2, ':', c = 'purple')
    ax2.plot(T_2, t_quark_sdensity_2, '-', c = 'purple')

    ax2.text(85, 18.5, r"$\mathrm{\mu_B/T=2.5}$", color="black", fontsize=14)
    ax2.text(250, 17.3, r"QGP", color="blue", fontsize=14)
    ax2.text(165.5, 18.5, r"PNJL", color="darkblue", fontsize=14)
    ...
    ax3.plot(T_2, qgp_old_bdensity_v_2, '--', c = 'blue')
    ax3.plot(T_2, qgp_bdensity_v_2, '-', c = 'blue')
    ax3.plot(T_2, t_pnjl_bdensity_old_2, '-.', c = 'darkblue')
    ...
    ax3.text(250, 0.95, r"PNJL", color="darkblue", fontsize=14)
...
def epja_experimental_full():
    ...
    def qgp_bdensity_all(T: float, muB: float, phi_re_0=1e-5, phi_im_0=2e-5, calc_phi=True):
        ...
        #Gluon bdensity
        partial.append(gluon.bdensity(*pars)/(T**3))
        #Sea bdensity
        lq_temp = pnjl.thermo.gcp_sea_lattice.bdensity(T, muB/3.0, 'l')/(T**3)
        sq_temp = pnjl.thermo.gcp_sea_lattice.bdensity(T, muB/3.0, 's')/(T**3)
        partial.append(lq_temp)
    ...
    def qgp_sdensity_all(T: float, muB: float, phi_re_0=1e-5, phi_im_0=2e-5, calc_phi=True):
        ...
        #Gluon sdensity
        partial.append(gluon.sdensity(*pars)/(T**3))
        #Sea sdensity
        lq_temp = pnjl.thermo.gcp_sea_lattice.sdensity(T, muB/3.0, 'l')/(T**3)
        sq_temp = pnjl.thermo.gcp_sea_lattice.sdensity(T, muB/3.0, 's')/(T**3)
        partial.append(lq_temp)
...
def epja_figure9_alt():
    ...
    ax1.plot(T_1, total_tcluster_1s, '--', c = 'red')
    ax1.plot(T_1, total_qgp_1, '--', c = 'blue')
    ax1.plot(T_1, total_1, '-', c = 'black')

    ax1.text(
        160.0, 0.005, r'MHRG with continuum', color='green', fontsize=14
    )
    ax1.text(
        160.0, -0.025, r'MHRG without continuum', color='red', fontsize=14
    )
    ax1.text(
    ...
    ax1.text(
        158.0, -0.06, r'Perturbative', color='magenta', fontsize=14
    )
    ax1.text(
    ...
    ax3.plot(T_2, total_tcluster_2s, '--', color='red')
    ax3.plot(T_2, total_qgp_2, '--', c='blue')
    ax3.plot(T_2, total_2, '-', c='black')

    ax3.text(
        160.0, 0.04, r'MHRG with continuum', color='green', fontsize=14
    )
    ax3.text(
        160.0, 0.01, r'MHRG without continuum', color='red', fontsize=14
    )
    ax3.text(
        140.0, 0.123, r'QGP', color='blue', fontsize=14
    )
    ax3.text(
        280.0, 0.25, r'NJL', color='blue', fontsize=14
    )
    ax3.text(
...
def epja_figure11():
    ...
    lattice = "D:/EoS/epja/lattice_data_pickled/"
    lattice2 = "D:/EoS/lattice_data/datafiles_cumulants_2dII/"
    if platform.system() == "Linux":
        files = "/home/mcierniak/Data/2023_epja/figure11/"
        lattice = "/home/mcierniak/Data/2023_epja/lattice_data_pickled/"
        lattice2 = "/home/mcierniak/Data/2023_epja/lattice_data/datafiles_cumulants_2dII/"
    ...
    if calc_1:
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_pi_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'pi'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_K_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'K'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_rho_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'rho'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_omega_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'omega'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_D_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'D'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_N_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'N'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_T_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'T'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_F_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'F'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_P_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'P'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_Q_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'Q'
                )
            )
        ...
        for T_el, mu_el, phi_re_el, phi_im_el in tqdm.tqdm(
            ...
            chi_H_v_1.append(
                cluster_s.qnumber_cumulant_buns(
                    2, T_el, mu_el, phi_re_el, phi_im_el, 'H'
                )
            )
    ...
    with open(lattice + "2012_12894_R12_0p4.pickle", "rb") as file:
        R12_lQCD_0p4 = pickle.load(file)
    with open(lattice + "2012_12894_R12_0p8.pickle", "rb") as file:
    ...
    l_2202_09184_T200, l_2202_09184_BQS200, l_2202_09184_BQS200_err = \
        utils.data_load(
            lattice2 + "fig1_exp_coefficients_B2_cont_extr_muQ_muS_zero.txt",
            0, 1, 3,
    ...
    l_2202_09184_T400, l_2202_09184_BQS400, l_2202_09184_BQS400_err = \
        utils.data_load(
            lattice2 + "fig1_exp_coefficients_B4_cont_extr_muQ_muS_zero.txt",
            0, 1, 3,
    ...
    l_2202_09184_T600, l_2202_09184_BQS600, l_2202_09184_BQS600_err = \
        utils.data_load(
            lattice2 + "fig1_exp_coefficients_B6_spline_muQ_muS_zero.txt",
            0, 1, 3,
    ...
    l_2202_09184_T800, l_2202_09184_BQS800, l_2202_09184_BQS800_err = \
        utils.data_load(
            lattice2 + "fig1_exp_coefficients_B8_spline_muQ_muS_zero.txt",
            0, 1, 3,
            firstrow=21, delim=None
        )
